...

{
  ...
  //TSystemDirectory dir("data","/data/ADRIANO2/TB_2019_dec/");
  TSystemDirectory dir("data","../"); //TSystemDirectory dir("data","./");
  int start=30;        //First event
  ...
  int RunNo =  1190; //1009; //1196;//810;   //RUN to select
