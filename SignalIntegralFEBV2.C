...
void SignalIntegralFEBV2(Int_t RunNo, const Int_t Nch, Int_t *chlist, Bool_t *IsSiPMChList, Int_t *XMaxList, Int_t FirstEvent=0, Int_t EventsToProcess=-1, Int_t dataset=2019, Int_t subdataset=1, TString path="./ntup", Bool_t debug=0, Int_t wfsize = 127, Int_t nfit = 1, Bool_t bShift=1, Bool_t bFast=0, Bool_t bUseMWPC=0)
{
...
//   }
  ...
  TFile *pfiled = new TFile(Form("./sigint/SignalIntegralFEBV2_%03d_%02d_1025test_ogfitfn2_newparam.root",dataset,subdataset),"UPDATE", "ADRIANO", 9);
  ...
  //cout << Form("%d, %d", nEntriesMB1, nEntriesMB2) << endl;
...
for(Int_t iEvt=FirstEvent+20;iEvt<FirstEvent+21;iEvt++){
